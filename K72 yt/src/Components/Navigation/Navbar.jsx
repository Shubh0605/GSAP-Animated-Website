    ...
    return (
        <div className='z-4 flex fixed top-0 w-full item-start justify-between'>
            ...
            onMouseLeave={()=>{
             ...
             className='lg:h-13 h-11 bg-black relative lg:w-[15vw] w-48'>
                <div ref ={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div className='relative h-full lg:px-8 px-5 flex flex-col justify-center items-end lg:gap-1 gap-0.5'>
                    <div className ='lg:w-15 w-9 h-0.5 bg-white'></div>
